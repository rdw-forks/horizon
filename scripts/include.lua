...
scripts = {
	...
	"scripts/monsters/dungeons/gefenia.lua",
	"scripts/monsters/dungeons/lou_dun.lua",
	"scripts/monsters/dungeons/mag_dun.lua",
	"scripts/monsters/dungeons/kh_dun.lua",
	"scripts/monsters/dungeons/ein_dun.lua",
	"scripts/monsters/dungeons/moc_pryd.lua",
	"scripts/monsters/dungeons/bra_dun.lua",
	"scripts/monsters/dungeons/mjo_dun.lua",
	"scripts/monsters/dungeons/prt_maze.lua",
	"scripts/monsters/dungeons/mal_dun.lua",
	"scripts/monsters/dungeons/ice_dun.lua",
	"scripts/monsters/dungeons/orcsdun.lua",
	"scripts/monsters/dungeons/ma_dun.lua",
	"scripts/monsters/dungeons/tur_dun.lua",
	"scripts/monsters/dungeons/tha_t.lua",
	"scripts/monsters/dungeons/ayo_dun.lua",
	"scripts/monsters/dungeons/iz_dun.lua",
	"scripts/monsters/dungeons/xmas_dun.lua",
	"scripts/monsters/dungeons/gld_dunSE.lua",
	"scripts/monsters/dungeons/dic_dun.lua",
	"scripts/monsters/dungeons/yggdrasil.lua",
	"scripts/monsters/dungeons/dew_dun.lua",
	"scripts/monsters/dungeons/gef_dun.lua",
	"scripts/monsters/dungeons/alde_dun.lua",
	"scripts/monsters/dungeons/beach_dun.lua",
	"scripts/monsters/dungeons/ra_san.lua",
	"scripts/monsters/dungeons/odin.lua",
	"scripts/monsters/dungeons/gld_re.lua",
	"scripts/monsters/dungeons/abbey.lua",
	"scripts/monsters/dungeons/ecl_tdun.lua",
	"scripts/monsters/dungeons/pay_dun.lua",
	"scripts/monsters/dungeons/thor_v.lua",
	"scripts/monsters/dungeons/lhz_dun.lua",
	"scripts/monsters/dungeons/nyd_dun.lua",
	"scripts/monsters/dungeons/ama_dun.lua",
	"scripts/monsters/dungeons/anthell.lua",
	"scripts/monsters/dungeons/treasure.lua",
	"scripts/monsters/dungeons/juperos.lua",
	"scripts/monsters/dungeons/mosk_dun.lua",
	"scripts/monsters/dungeons/prt_sew.lua",
	"scripts/monsters/dungeons/glastheim.lua",
	"scripts/monsters/dungeons/c_tower.lua",
	"scripts/monsters/dungeons/abyss.lua",
	"scripts/monsters/dungeons/in_sphinx.lua",
	"scripts/monsters/dungeons/gon_dun.lua",

	"scripts/monsters/fields/malaya.lua",
	"scripts/monsters/fields/splendide.lua",
	"scripts/monsters/fields/rachel.lua",
	"scripts/monsters/fields/moscovia.lua",
	"scripts/monsters/fields/veins.lua",
	"scripts/monsters/fields/comodo.lua",
	"scripts/monsters/fields/yuno.lua",
	"scripts/monsters/fields/ayothaya.lua",
	"scripts/monsters/fields/louyang.lua",
	"scripts/monsters/fields/hugel.lua",
	"scripts/monsters/fields/mjolnir.lua",
	"scripts/monsters/fields/gonryun.lua",
	"scripts/monsters/fields/dicastes.lua",
	"scripts/monsters/fields/brasilis.lua",
	"scripts/monsters/fields/morocc.lua",
	"scripts/monsters/fields/lutie.lua",
	"scripts/monsters/fields/einbroch.lua",
	"scripts/monsters/fields/eclage.lua",
	"scripts/monsters/fields/umbala.lua",
	"scripts/monsters/fields/bifrost.lua",
	"scripts/monsters/fields/lighthalzen.lua",
	"scripts/monsters/fields/prontera.lua",
	"scripts/monsters/fields/geffen.lua",
	"scripts/monsters/fields/dewata.lua",
	"scripts/monsters/fields/niflheim.lua",
	"scripts/monsters/fields/amatsu.lua",
	"scripts/monsters/fields/manuk.lua",
	"scripts/monsters/fields/payon.lua",

	"scripts/monsters/citycleaners.lua",
	"scripts/monsters/champion.lua",
	"scripts/monsters/towns.lua",
	"scripts/monsters/int_land.lua",
}
