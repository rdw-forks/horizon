...
{	
	...
	class Bonus : public Attribute
	{
	public:
		Bonus(std::weak_ptr<Unit> unit, status_point_type st_type, int32_t base = 0, int32_t equip = 0, int32_t status = 0)
		: Attribute(unit, st_type, base, equip, status)
		{
		}
	...
	class Bonus2 : public Attribute
	{
	public:
		Bonus2(std::weak_ptr<Unit> unit, status_point_type st_type, SubType type, int32_t base = 0, int32_t equip = 0, int32_t status = 0)
		: Attribute(unit, st_type, base, equip, status)
		{
		}
	...
	class Bonus3 : public Attribute
	{
	public:
		Bonus3(std::weak_ptr<Unit> unit, status_point_type st_type, Type type, SubType sub_type, int32_t base = 0, int32_t equip = 0, int32_t status = 0)
		: Attribute(unit, st_type, base, equip, status)
		{
		}
		...
		Type get_type() const { return _type; }
		SubType get_type() const { return _sub_type; }
	...
	template <typename Type, typename SubType, typename SubSubType>
	class Bonus4 : public Attribute
	{
	public:
		Bonus4(std::weak_ptr<Unit> unit, status_point_type st_type, Type type, SubType sub_type, SubSubType sub_sub_type, int32_t base = 0, int32_t equip = 0, int32_t status = 0)
		: Attribute(unit, st_type, base, equip, status)
		{
		}
		...
		Type get_type() const { return _type; }
		SubType get_type() const { return _sub_type; }
		SubSubType get_type() const { return _sub_sub_type; }
	
	private:
		Type _type;
		SubType _sub_type;
		SubSubType _sub_sub_type;
	};
