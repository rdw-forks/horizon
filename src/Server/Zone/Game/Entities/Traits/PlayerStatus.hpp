...
#ifndef HORIZON_ZONE_GAME_TRAITS_PLAYERSTATUS_HPP
#define HORIZON_ZONE_GAME_TRAITS_PLAYERSTATUS_HPP

#include "Server/Zone/Game/Entities/Tratis/Status.hpp"
...
{
public:
	PlayerStatus(std::weak_ptr<Entity> entity) : _entity(entity), Status(entity) { }
	~PlayerStatus() { }
