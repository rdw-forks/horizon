...
#ifndef HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20120515
#define HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20120515
...
#define ADD_TPKT(i, j, k) _tpacket_length_table.insert(i, std::make_pair(j, std::make_shared<k>(s)))
		...
		ADD_TPKT(0x0982, 3, ZC_FATIGUE_CHN);
...
#endif /* HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20120515 */