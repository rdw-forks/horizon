...
#ifndef HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20081029
#define HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20081029
...
#define ADD_TPKT(i, j, k) _tpacket_length_table.insert(i, std::make_pair(j, std::make_shared<k>(s)))
		...
		ADD_HPKT(0x00e8, 39, CZ_ADD_EXCHANGE_ITEM);
		...
		ADD_HPKT(0x00b8, 44, CZ_CHOOSE_MENU);
		ADD_HPKT(0x022d, -1, CZ_COMMAND_MER);
		ADD_HPKT(0x00eb, 3, CZ_CONCLUDE_EXCHANGE_ITEM);
		ADD_HPKT(0x0090, 8, CZ_CONTACTNPC);
		ADD_HPKT(0x00d5, 2, CZ_CREATE_CHATROOM);
		ADD_HPKT(0x00ce, 282, CZ_DISCONNECT_ALL_CHARACTER);
		...
		ADD_HPKT(0x0134, 15, CZ_PC_PURCHASE_ITEMLIST_FROMMC);
		ADD_HPKT(0x00c9, 26, CZ_PC_SELL_ITEMLIST);
		...
		ADD_HPKT(0x0233, 16, CZ_REQUEST_ACTNPC);
		...
		ADD_HPKT(0x015b, 27, CZ_REQ_BAN_GUILD);
		ADD_HPKT(0x0130, 5, CZ_REQ_BUY_FROMMC);
		ADD_HPKT(0x0155, 4, CZ_REQ_CHANGE_MEMBERPOS);
		ADD_HPKT(0x012e, -1, CZ_REQ_CLOSESTORE);
		ADD_HPKT(0x00bf, 16, CZ_REQ_EMOTION);
		ADD_HPKT(0x00e4, 26, CZ_REQ_EXCHANGE_ITEM);
		ADD_HPKT(0x0103, 10, CZ_REQ_EXPEL_GROUP_MEMBER);
		ADD_HPKT(0x00e2, -1, CZ_REQ_EXPEL_MEMBER);
		ADD_HPKT(0x0149, 3, CZ_REQ_GIVE_MANNER_POINT);
		...
		ADD_HPKT(0x01bb, 90, CZ_SHIFT);
		ADD_HPKT(0x00bb, 30, CZ_STATUS_CHANGE);
		...
		ADD_TPKT(0x0111, 97, ZC_ADD_SKILL);
		...
		ADD_TPKT(0x009a, 19, ZC_BROADCAST);
		...
		ADD_TPKT(0x00f6, 57, ZC_DELETE_ITEM_FROM_STORE);
		...
		ADD_TPKT(0x007a, 26, ZC_NOTIFY_ACTENTRY);
		ADD_TPKT(0x0121, 6, ZC_NOTIFY_CARTITEM_COUNTINFO);
		ADD_TPKT(0x0109, 3, ZC_NOTIFY_CHAT_PARTY);
		ADD_TPKT(0x0117, 13, ZC_NOTIFY_GROUNDSKILL);
		ADD_TPKT(0x0106, 3, ZC_NOTIFY_HP_TO_GROUPM);
		ADD_TPKT(0x0199, 8, ZC_NOTIFY_MAPPROPERTY);
		ADD_TPKT(0x0086, 6, ZC_NOTIFY_MOVE);
		...
		ADD_TPKT(0x01d9, 23, ZC_NOTIFY_NEWENTRY2);
		...
		ADD_TPKT(0x0080, 9, ZC_NOTIFY_VANISH);
		ADD_TPKT(0x0093, -1, ZC_NPCACK_ENABLE);
		ADD_TPKT(0x0092, 29, ZC_NPCACK_SERVERMOVE);
		ADD_TPKT(0x0142, 8, ZC_OPEN_EDITDLG);
		ADD_TPKT(0x01ab, -1, ZC_PAR_CHANGE_USER);
		ADD_TPKT(0x0287, 60, ZC_PC_CASH_POINT_ITEMLIST);
		ADD_TPKT(0x0133, 102, ZC_PC_PURCHASE_ITEMLIST_FROMMC);
		...
		ADD_TPKT(0x022e, 60, ZC_PROPERTY_HOMUN);
		ADD_TPKT(0x01a2, -1, ZC_PROPERTY_PET);
		ADD_TPKT(0x013d, 53, ZC_RECOVERY);
		...
		ADD_TPKT(0x016a, 19, ZC_REQ_JOIN_GUILD);
		...
		ADD_TPKT(0x00c4, 67, ZC_SELECT_DEALTYPE);
		ADD_TPKT(0x01b3, 36, ZC_SHOW_IMAGE2);
		ADD_TPKT(0x010e, 10, ZC_SKILLINFO_UPDATE);
		ADD_TPKT(0x01c9, 14, ZC_SKILL_ENTRY2);
		ADD_TPKT(0x01d0, 21, ZC_SPIRITS);
		ADD_TPKT(0x01e1, 86, ZC_SPIRITS2);
		ADD_TPKT(0x00c3, 2, ZC_SPRITE_CHANGE);
		...
		ADD_TPKT(0x00b5, 26, ZC_WAIT_DIALOG);
...
#endif /* HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20081029 */