...
#ifndef HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20080708
#define HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20080708
...
#define ADD_TPKT(i, j, k) _tpacket_length_table.insert(i, std::make_pair(j, std::make_shared<k>(s)))
		ADD_HPKT(0x00e6, 33, CZ_ACK_EXCHANGE_ITEM);
		ADD_HPKT(0x0208, 16, CZ_ACK_REQ_ADD_FRIENDS);
		ADD_HPKT(0x00c5, 16, CZ_ACK_SELECT_DEALTYPE);
		ADD_HPKT(0x0172, 102, CZ_ALLY_GUILD);
		ADD_HPKT(0x0217, -1, CZ_BLACKSMITH_RANK);
		ADD_HPKT(0x0099, 182, CZ_BROADCAST);
		...
		ADD_HPKT(0x01ed, 54, CZ_CHOPOKGI);
		ADD_HPKT(0x0146, 28, CZ_CLOSE_DIALOG);
		...
		ADD_HPKT(0x01e7, 27, CZ_DORIDORI);
		ADD_HPKT(0x00ef, 30, CZ_EXEC_EXCHANGE_ITEM);
		ADD_HPKT(0x00e3, -1, CZ_EXIT_ROOM);
		ADD_HPKT(0x017e, 11, CZ_GUILD_CHAT);
		ADD_HPKT(0x016e, 5, CZ_GUILD_NOTICE);
		...
		ADD_HPKT(0x0237, 11, CZ_KILLER_RANK);
		ADD_HPKT(0x019c, -1, CZ_LOCALBROADCAST);
		ADD_HPKT(0x00f9, 30, CZ_MAKE_GROUP);
		ADD_HPKT(0x01e8, 8, CZ_MAKE_GROUP2);
		ADD_HPKT(0x0126, 24, CZ_MOVE_ITEM_FROM_BODY_TO_CART);
		...
		ADD_HPKT(0x01bd, 43, CZ_RECALL_GID);
		...
		ADD_HPKT(0x0232, 12, CZ_REQUEST_MOVENPC);
		ADD_HPKT(0x0360, -1, CZ_REQUEST_TIME2);
		ADD_HPKT(0x0170, 14, CZ_REQ_ALLY_GUILD);
		ADD_HPKT(0x015b, 8, CZ_REQ_BAN_GUILD);
		ADD_HPKT(0x0130, 6, CZ_REQ_BUY_FROMMC);
		ADD_HPKT(0x0155, 8, CZ_REQ_CHANGE_MEMBERPOS);
		ADD_HPKT(0x012e, 2, CZ_REQ_CLOSESTORE);
		ADD_HPKT(0x018a, 10, CZ_REQ_DISCONNECT);
		ADD_HPKT(0x00bf, 54, CZ_REQ_EMOTION);
		ADD_HPKT(0x00d9, 28, CZ_REQ_ENTER_ROOM);
		ADD_HPKT(0x00e4, 15, CZ_REQ_EXCHANGE_ITEM);
		...
		ADD_HPKT(0x0100, 22, CZ_REQ_LEAVE_GROUP);
		...
		ADD_HPKT(0x00e0, 16, CZ_REQ_ROLE_CHANGE);
		ADD_HPKT(0x00c1, 29, CZ_REQ_USER_COUNT);
		ADD_HPKT(0x00a9, 10, CZ_REQ_WEAR_EQUIP);
		ADD_HPKT(0x00b2, 3, CZ_RESTART);
		ADD_HPKT(0x01a7, 6, CZ_SELECT_PETEGG);
		ADD_HPKT(0x011b, 14, CZ_SELECT_WARPPOINT);
		ADD_HPKT(0x00d0, 68, CZ_SETTING_WHISPER_STATE);
		...
		ADD_TPKT(0x00ea, 81, ZC_ACK_ADD_EXCHANGE_ITEM);
		...
		ADD_TPKT(0x018f, 21, ZC_ACK_REQMAKINGITEM);
		ADD_TPKT(0x0095, -1, ZC_ACK_REQNAME);
		ADD_TPKT(0x0195, -1, ZC_ACK_REQNAMEALL);
		ADD_TPKT(0x0194, 10, ZC_ACK_REQNAME_BYGID);
		ADD_TPKT(0x018b, 65, ZC_ACK_REQ_DISCONNECT);
		ADD_TPKT(0x0169, 9, ZC_ACK_REQ_JOIN_GUILD);
		ADD_TPKT(0x0098, 39, ZC_ACK_WHISPER);
		...
		ADD_TPKT(0x021a, 79, ZC_ALCHEMIST_RANK);
		ADD_TPKT(0x0139, 12, ZC_ATTACK_FAILURE_FOR_DISTANCE);
		...
		ADD_TPKT(0x0122, 282, ZC_CART_EQUIPMENT_ITEMLIST);
		ADD_TPKT(0x0297, 67, ZC_CART_EQUIPMENT_ITEMLIST2);
		ADD_TPKT(0x0123, 2, ZC_CART_NORMAL_ITEMLIST);
		ADD_TPKT(0x01ef, 6, ZC_CART_NORMAL_ITEMLIST2);
		ADD_TPKT(0x00df, 29, ZC_CHANGE_CHATROOM);
		...
		ADD_TPKT(0x0125, 3, ZC_DELETE_ITEM_FROM_CART);
		ADD_TPKT(0x00f6, -1, ZC_DELETE_ITEM_FROM_STORE);
		ADD_TPKT(0x01cf, 14, ZC_DEVOTIONLIST);
		...
		ADD_TPKT(0x01b6, 10, ZC_GUILD_INFO2);
		ADD_TPKT(0x016f, 30, ZC_GUILD_NOTICE);
		...
		ADD_TPKT(0x009d, 14, ZC_ITEM_ENTRY);
		ADD_TPKT(0x00a0, 90, ZC_ITEM_PICKUP_ACK);
		ADD_TPKT(0x029a, 6, ZC_ITEM_PICKUP_ACK2);
		ADD_TPKT(0x00af, 42, ZC_ITEM_THROW_ACK);
		ADD_TPKT(0x00b1, -1, ZC_LONGPAR_CHANGE);
		ADD_TPKT(0x018d, 3, ZC_MAKABLEITEMLIST);
		ADD_TPKT(0x01ad, 66, ZC_MAKINGARROW_LIST);
		...
		ADD_TPKT(0x008a, 53, ZC_NOTIFY_ACT);
		...
		ADD_TPKT(0x0092, 18, ZC_NPCACK_SERVERMOVE);
		...
		ADD_TPKT(0x0287, 30, ZC_PC_CASH_POINT_ITEMLIST);
		ADD_TPKT(0x0133, 4, ZC_PC_PURCHASE_ITEMLIST_FROMMC);
		ADD_TPKT(0x0136, -1, ZC_PC_PURCHASE_MYITEMLIST);
		ADD_TPKT(0x00ca, 8, ZC_PC_PURCHASE_RESULT);
		ADD_TPKT(0x0135, 5, ZC_PC_PURCHASE_RESULT_FROMMC);
		ADD_TPKT(0x00c7, 27, ZC_PC_SELL_ITEMLIST);
		ADD_TPKT(0x01a6, 57, ZC_PETEGG_LIST);
		...
		ADD_TPKT(0x0207, 14, ZC_REQ_ADD_FRIENDS);
		ADD_TPKT(0x0171, -1, ZC_REQ_ALLY_GUILD);
		ADD_TPKT(0x01f4, 6, ZC_REQ_EXCHANGE_ITEM2);
		ADD_TPKT(0x023a, 9, ZC_REQ_STORE_PASSWORD);
		ADD_TPKT(0x00ac, 11, ZC_REQ_TAKEOFF_EQUIP_ACK);
		...
		ADD_TPKT(0x00c4, 186, ZC_SELECT_DEALTYPE);
		ADD_TPKT(0x00d1, -1, ZC_SETTING_WHISPER_PC);
		ADD_TPKT(0x00d2, -1, ZC_SETTING_WHISPER_STATE);
		ADD_TPKT(0x01b3, 6, ZC_SHOW_IMAGE2);
		ADD_TPKT(0x010f, 35, ZC_SKILLINFO_LIST);
		ADD_TPKT(0x0120, 30, ZC_SKILL_DISAPPEAR);
		ADD_TPKT(0x011f, -1, ZC_SKILL_ENTRY);
		ADD_TPKT(0x01c9, 4, ZC_SKILL_ENTRY2);
		ADD_TPKT(0x01d0, 33, ZC_SPIRITS);
		ADD_TPKT(0x00c3, 9, ZC_SPRITE_CHANGE);
		ADD_TPKT(0x01d7, 27, ZC_SPRITE_CHANGE2);
		ADD_TPKT(0x020e, -1, ZC_STARSKILL);
		ADD_TPKT(0x0119, 4, ZC_STATE_CHANGE);
		ADD_TPKT(0x0229, 20, ZC_STATE_CHANGE3);
		...
		ADD_TPKT(0x0296, 282, ZC_STORE_EQUIPMENT_ITEMLIST2);
		ADD_TPKT(0x01f0, 55, ZC_STORE_NORMAL_ITEMLIST2);
		ADD_TPKT(0x0224, -1, ZC_TAEKWON_POINT);
		ADD_TPKT(0x0226, 6, ZC_TAEKWON_RANK);
		ADD_TPKT(0x01a0, 10, ZC_TRYCAPTURE_MONSTER);
		ADD_TPKT(0x016d, 7, ZC_UPDATE_CHARSTAT);
		ADD_TPKT(0x01f2, 30, ZC_UPDATE_CHARSTAT2);
		...
		ADD_TPKT(0x00b5, 58, ZC_WAIT_DIALOG);
		ADD_TPKT(0x011c, 15, ZC_WARPLIST);
...
#endif /* HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20080708 */