...
#ifndef HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20090129
#define HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20090129
...
#define ADD_TPKT(i, j, k) _tpacket_length_table.insert(i, std::make_pair(j, std::make_shared<k>(s)))
		...
		ADD_HPKT(0x00e8, 14, CZ_ADD_EXCHANGE_ITEM);
		...
		ADD_HPKT(0x02f3, 8, CZ_IRMAIL_SEND);
		...
		ADD_HPKT(0x0127, 30, CZ_MOVE_ITEM_FROM_CART_TO_BODY);
		ADD_HPKT(0x0129, 10, CZ_MOVE_ITEM_FROM_CART_TO_STORE);
		ADD_HPKT(0x0128, -1, CZ_MOVE_ITEM_FROM_STORE_TO_CART);
		ADD_HPKT(0x00c8, 26, CZ_PC_PURCHASE_ITEMLIST);
		ADD_HPKT(0x0134, 6, CZ_PC_PURCHASE_ITEMLIST_FROMMC);
		ADD_HPKT(0x01bc, -1, CZ_RECALL);
		ADD_HPKT(0x01bd, 10, CZ_RECALL_GID);
		ADD_HPKT(0x0161, 54, CZ_REG_CHANGE_GUILD_POSITIONINFO);
		...
		ADD_HPKT(0x00e4, 20, CZ_REQ_EXCHANGE_ITEM);
		ADD_HPKT(0x0103, -1, CZ_REQ_EXPEL_GROUP_MEMBER);
		ADD_HPKT(0x014f, 26, CZ_REQ_GUILD_MENU);
		...
		ADD_HPKT(0x0168, 27, CZ_REQ_JOIN_GUILD);
		ADD_HPKT(0x0165, 6, CZ_REQ_MAKE_GUILD);
		ADD_HPKT(0x00b9, 31, CZ_REQ_NEXT_SCRIPT);
		ADD_HPKT(0x01b2, 7, CZ_REQ_OPENSTORE2);
		...
		ADD_HPKT(0x01ce, 14, CZ_SELECTAUTOSPELL);
		ADD_HPKT(0x01a7, 5, CZ_SELECT_PETEGG);
		ADD_HPKT(0x011b, -1, CZ_SELECT_WARPPOINT);
		ADD_HPKT(0x00cf, 10, CZ_SETTING_WHISPER_PC);
		ADD_HPKT(0x01bb, -1, CZ_SHIFT);
		ADD_HPKT(0x00bb, 9, CZ_STATUS_CHANGE);
		ADD_HPKT(0x0225, 44, CZ_TAEKWON_RANK);
		...
		ADD_TPKT(0x0179, 33, ZC_ACK_ITEMIDENTIFY);
		...
		ADD_TPKT(0x0169, 11, ZC_ACK_REQ_JOIN_GUILD);
		ADD_TPKT(0x0110, -1, ZC_ACK_TOUSESKILL);
		ADD_TPKT(0x0098, -1, ZC_ACK_WHISPER);
		ADD_TPKT(0x013b, 32, ZC_ACTION_FAILURE);
		ADD_TPKT(0x00e9, 32, ZC_ADD_EXCHANGE_ITEM);
		ADD_TPKT(0x0209, 86, ZC_ADD_FRIENDS_LIST);
		ADD_TPKT(0x0124, 28, ZC_ADD_ITEM_TO_CART);
		...
		ADD_TPKT(0x0163, 9, ZC_BAN_LIST);
		ADD_TPKT(0x021b, 55, ZC_BLACKSMITH_POINT);
		ADD_TPKT(0x0219, 58, ZC_BLACKSMITH_RANK);
		ADD_TPKT(0x009a, -1, ZC_BROADCAST);
		ADD_TPKT(0x01c3, -1, ZC_BROADCAST2);
		ADD_TPKT(0x00ee, 24, ZC_CANCEL_EXCHANGE_ITEM);
		ADD_TPKT(0x0122, 20, ZC_CART_EQUIPMENT_ITEMLIST);
		...
		ADD_TPKT(0x01a4, 27, ZC_CHANGESTATE_PET);
		ADD_TPKT(0x00df, 2, ZC_CHANGE_CHATROOM);
		ADD_TPKT(0x00b6, 2, ZC_CLOSE_DIALOG);
		ADD_TPKT(0x00f8, 60, ZC_CLOSE_STORE);
		...
		ADD_TPKT(0x0105, 14, ZC_DELETE_MEMBER_FROM_GROUP);
		ADD_TPKT(0x00d8, 15, ZC_DESTROY_ROOM);
		...
		ADD_TPKT(0x010c, 27, ZC_MVP);
		ADD_TPKT(0x010a, 22, ZC_MVP_GETTING_ITEM);
		ADD_TPKT(0x010b, -1, ZC_MVP_GETTING_SPECIAL_EXP);
		ADD_TPKT(0x014c, 5, ZC_MYGUILD_BASIC_INFO);
		...
		ADD_TPKT(0x0199, 26, ZC_NOTIFY_MAPPROPERTY);
		ADD_TPKT(0x01d6, 26, ZC_NOTIFY_MAPPROPERTY2);
		...
		ADD_TPKT(0x01d9, 37, ZC_NOTIFY_NEWENTRY2);
		...
		ADD_TPKT(0x01eb, 23, ZC_NOTIFY_POSITION_TO_GUILDM);
		...
		ADD_TPKT(0x01c9, 102, ZC_SKILL_ENTRY2);
		ADD_TPKT(0x01d0, 10, ZC_SPIRITS);
		ADD_TPKT(0x01e1, -1, ZC_SPIRITS2);
		ADD_TPKT(0x01d7, 16, ZC_SPRITE_CHANGE2);
		...
		ADD_TPKT(0x0224, 16, ZC_TAEKWON_POINT);
		ADD_TPKT(0x0226, -1, ZC_TAEKWON_RANK);
		ADD_TPKT(0x016d, -1, ZC_UPDATE_CHARSTAT);
		ADD_TPKT(0x00c2, 60, ZC_USER_COUNT);
		ADD_TPKT(0x013e, -1, ZC_USESKILL_ACK);
		ADD_TPKT(0x00a8, 54, ZC_USE_ITEM_ACK);
		ADD_TPKT(0x011a, 282, ZC_USE_SKILL);
#undef ADD_TPKT
#undef ADD_HPKT
	}
...
#endif /* HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20090129 */