...
#define ADD_TPKT(i, j, k) _tpacket_length_table.insert(i, std::make_pair(j, std::make_shared<k>(s)))
		...
		ADD_HPKT(0x0237, 15, CZ_KILLER_RANK);
		...
		ADD_HPKT(0x0128, 18, CZ_MOVE_ITEM_FROM_STORE_TO_CART);
		ADD_HPKT(0x007d, 2, CZ_NOTIFY_ACTORINIT);
		ADD_HPKT(0x0134, 11, CZ_PC_PURCHASE_ITEMLIST_FROMMC);
		...
		ADD_HPKT(0x0170, 44, CZ_REQ_ALLY_GUILD);
		...
		ADD_HPKT(0x00bf, 22, CZ_REQ_EMOTION);
		...
		ADD_TPKT(0x013b, 33, ZC_ACTION_FAILURE);
		...
		ADD_TPKT(0x00f4, 30, ZC_ADD_ITEM_TO_STORE);
		...
		ADD_TPKT(0x021c, 33, ZC_ALCHEMIST_POINT);
		...
		ADD_TPKT(0x00d8, 28, ZC_DESTROY_ROOM);
		...
		ADD_TPKT(0x0162, 11, ZC_GUILD_SKILLINFO);
		...
		ADD_TPKT(0x0154, 282, ZC_MEMBERMGR_INFO);
		...
		ADD_TPKT(0x0189, 9, ZC_NOTIFY_MAPINFO);
		ADD_TPKT(0x0199, 6, ZC_NOTIFY_MAPPROPERTY);
		ADD_TPKT(0x01d6, 14, ZC_NOTIFY_MAPPROPERTY2);
		...
		ADD_TPKT(0x008e, 30, ZC_NOTIFY_PLAYERCHAT);
		...
		ADD_TPKT(0x00f2, 27, ZC_NOTIFY_STOREITEM_COUNTINFO);
		ADD_TPKT(0x007f, 6, ZC_NOTIFY_TIME);
		ADD_TPKT(0x0077, 28, ZC_NOTIFY_UPDATEPLAYER);
		ADD_TPKT(0x0080, 7, ZC_NOTIFY_VANISH);
		ADD_TPKT(0x0093, 15, ZC_NPCACK_ENABLE);
		ADD_TPKT(0x0091, 22, ZC_NPCACK_MAPMOVE);
		ADD_TPKT(0x0092, 28, ZC_NPCACK_SERVERMOVE);
		ADD_TPKT(0x01b0, 32, ZC_NPCSPRITE_CHANGE);
		ADD_TPKT(0x012d, 67, ZC_OPENSTORE);
		...
		ADD_TPKT(0x00e1, 59, ZC_ROLE_CHANGE);
		ADD_TPKT(0x00d7, 27, ZC_ROOM_NEWENTRY);
		ADD_TPKT(0x00b4, 282, ZC_SAY_DIALOG);
		ADD_TPKT(0x00c4, 6, ZC_SELECT_DEALTYPE);
		ADD_TPKT(0x00d1, 282, ZC_SETTING_WHISPER_PC);
		...
		ADD_TPKT(0x0119, 43, ZC_STATE_CHANGE);
		...
		ADD_TPKT(0x0088, 18, ZC_STOPMOVE);
		ADD_TPKT(0x0131, 86, ZC_STORE_ENTRY);
		ADD_TPKT(0x0296, 21, ZC_STORE_EQUIPMENT_ITEMLIST2);
		...
		ADD_TPKT(0x01f2, 42, ZC_UPDATE_CHARSTAT2);
		ADD_TPKT(0x016c, 43, ZC_UPDATE_GDID);
		ADD_TPKT(0x00c2, 10, ZC_USER_COUNT);
		ADD_TPKT(0x013e, 68, ZC_USESKILL_ACK);
