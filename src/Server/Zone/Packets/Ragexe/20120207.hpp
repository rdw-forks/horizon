...
#ifndef HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20120207
#define HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20120207
...
#define ADD_TPKT(i, j, k) _tpacket_length_table.insert(i, std::make_pair(j, std::make_shared<k>(s)))
		...
		ADD_TPKT(0x096b, 3, ZC_PRNPC_STATE);
#undef ADD_TPKT
#undef ADD_HPKT
	}
...
#endif /* HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20120207 */