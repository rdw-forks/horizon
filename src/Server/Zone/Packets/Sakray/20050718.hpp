...
#define ADD_TPKT(i, j, k) _tpacket_length_table.insert(i, std::make_pair(j, std::make_shared<k>(s)))
		...
		ADD_HPKT(0x009b, 31, CZ_CHANGE_DIRECTION);
		ADD_HPKT(0x0072, 19, CZ_ENTER);
		ADD_HPKT(0x009f, 12, CZ_ITEM_PICKUP);
		ADD_HPKT(0x00a2, 18, CZ_ITEM_THROW);
		...
		ADD_HPKT(0x0190, 21, CZ_USE_SKILL_TOGROUND_WITHTALKBOX);
