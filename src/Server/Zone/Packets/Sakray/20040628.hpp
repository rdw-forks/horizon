...
#ifndef HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20040628
#define HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20040628
...
#define ADD_TPKT(i, j, k) _tpacket_length_table.insert(i, std::make_pair(j, std::make_shared<k>(s)))
		ADD_HPKT(0x0208, 11, CZ_ACK_REQ_ADD_FRIENDS);
...
#endif /* HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20040628 */