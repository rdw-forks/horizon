...
#ifndef HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20120214
#define HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20120214
...
#define ADD_TPKT(i, j, k) _tpacket_length_table.insert(i, std::make_pair(j, std::make_shared<k>(s)))
		...
		ADD_HPKT(0x096e, 10, CZ_REQ_MERGE_ITEM);
		...
		ADD_TPKT(0x096f, 3, ZC_ACK_MERGE_ITEM);
		ADD_TPKT(0x096d, 2, ZC_MERGE_ITEM_OPEN);
...
#endif /* HORIZON_ZONE_CLIENT_PACKET_LENGTH_TABLE_20120214 */