...
{
	ENTITY_MASK_PLAYER    = 0x0000,
	ENTITY_MASK_NPC       = 0x0001,
	ENTITY_MASK_ITEM      = 0x0002,
	ENTITY_MASK_SKILL     = 0x0004,
	ENTITY_MASK_UNKNOWN   = 0x0008,
	ENTITY_MASK_MONSTER   = 0x0010,
	ENTITY_MASK_EVENT     = 0x0020,
	ENTITY_MASK_PET       = 0x0040,
	ENTITY_MASK_HOMUNCULUS= 0x0080,
	ENTITY_MASK_MERCENARY = 0x0100,
...
enum status_point_type
{
	...
	STATUS_SIZE                   = 50005,
	STATUS_CREATURE_WEAPON_ATK    = 50006,
	STATUS_CREATE_ATTACK_DAMAGE   = 50007,
	STATUS_CREATURE_MAGIC_ATTACK_DAMAGE = 50008,
	STATUS_CREATURE_VIEW_RANGE    = 50009,
	STATUS_CREATURE_CHASE_RANGE   = 50010,
	STATUS_CREATURE_PRIMARY_RACE  = 50011,
	STATUS_CREATURE_SECONDARY_RACE= 50012,
	STATUS_CREATURE_ELEMENT       = 50013,
	STATUS_CREATURE_ELEMENT_LEVEL = 50014,
	STATUS_CREATURE_MODE          = 50015
};
