...
{
	sZone->get_component<GameLogicProcess>(GAME_LOGIC_MAINFRAME)->get_map_process().manage_session_in_map(SESSION_ACTION_LOGOUT_AND_REMOVE, get_map_name(), shared_from_this());
}
