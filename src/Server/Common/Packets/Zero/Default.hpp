...
#ifndef HORIZON_COMMON_CLIENT_PACKET_LENGTH_TABLE_0
#define HORIZON_COMMON_CLIENT_PACKET_LENGTH_TABLE_0
...
#define ADD_TPKT(i, j, k) _tpacket_length_table.insert(i, std::make_pair(j, std::make_shared<k>(s)))
		...
		ADD_TPKT(0x09c5, 1042, CS_LOGIN_QUERY);
		ADD_TPKT(0x01c6, 4, CS_REQ_ENCRYPTION);
...
#endif /* HORIZON_COMMON_CLIENT_PACKET_LENGTH_TABLE_0 */
