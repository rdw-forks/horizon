...
if (WITH_CORE_DEBUG)
	...
	message("-DCMAKE_BUILD_TYPE=RelWithDebugInfo")
	message("DO NOT ENABLE IT UNLESS YOU KNOW WHAT YOU'RE DOING!")
	message("* Use Core-side debug        : Yes")
	add_definitions(-DHORIZON_DEBUG)
else()
	message("* Use Core-side debug        : No  (default)")
endif()
...
if (WITHOUT_GIT)
	message("* Use GIT Revision Hash      : No (WARNING!)")
else()
	message("* Use GIT Revision Hash      : Yes (default)")
endif()

if (WITHOUT_SERVERS)
	message("* Without Servers            : Yes (Servers will not be built! This option is for test builds only.)")
else()
	message("* Without Servers            : No (Servers will be built)")
endif()
